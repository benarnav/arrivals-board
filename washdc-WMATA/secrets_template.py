...
secrets = {
    ...
    'wmata_key' : '', #api key from https://developer.wmata.com
    ...
    'transit_headers' : {'api_key': '',}, #fill in wmata api key here
    'station': '', #Home station code from https://developer.wmata.com/docs/services/5476364f031f590f38092507/operations/5476364f031f5909e4fe3311?
                   #for multiple stations (eg L'Enfant Plaza), separate with , and no spaces
