...
secrets = {
    ...
    "transit_headers": {
        ...
        "lines": "",  # optional: specify lines to be displayed, if not included will default to show all lines in station-ids. NB: write lines separated by commas. eg: "blue,silver"
